...
const teamMatchesDataApiUrl = 'https://apis.ccbp.in/ipl/'
...
class TeamMatches extends Component {
  ...
  getTeamMatchesData = async () => {
    ...
    const {params} = match
    const {id} = params
    const response = await fetch(`${teamMatchesDataApiUrl}${id}`)
  ...
  renderTeamMatches = () => {
    ...
    return (
      <div className="responsive-container-bg">
  ...
  renderLoader = () => (
    <div data-testid="loader" className="loader-container" testid="loader">
